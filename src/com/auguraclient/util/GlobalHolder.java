...
public class GlobalHolder {
	...
	private String[] CHECK_TYPE_ENUM = { "", "Visual", "Manual Test", "Ruler",
			"Scale", "Caliper", "Pulling Tool" };
	private String[] CHECK_TYPE_ENUM_VALUE = { "", "visual", "manual", "ruler",
			"scale", "caliper", "pulling_tool" };

	private String[] QC_ACTION_ENUM = { "", "Correct During QC",
			"Correct After QC", "Cannot Correct", "Refuse to Correct" };

	private String[] QC_ACTION_ENUM_VALUE = { "", "during_qc", "after_qc",
			"cannot", "refuse" };

	private String[] QC_Status_ENUM = { "", "Failed", "Passed", "Alert",
			"Ready" };

	private String[] QC_Status_ENUM_VALUE = { "", "failed", "passed", "alert",
			"ready" };
	...
	public String[] getQcStatusValue() {
		return this.QC_Status_ENUM_VALUE;
	}
}
