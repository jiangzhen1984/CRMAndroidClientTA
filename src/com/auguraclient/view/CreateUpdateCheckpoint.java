...
public class CreateUpdateCheckpoint extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkpointEditText = (EditText)this.findViewById(R.id.checkpointEditText);
        nameEditText = (EditText)this.findViewById(R.id.nameEditText);
        detailEditText = (EditText)this.findViewById(R.id.detailEditText);
        qcCommentEditText = (EditText)this.findViewById(R.id.qcCommentEditText);
        ...
        addOrUpdateTextView = (TextView)this.findViewById(R.id.bottom_tab_add_or_update_checkpoint);
        ...
        mContext = this;
        projectOrder = (ProjectOrder)this.getIntent().getSerializableExtra("projectOrder");
        if (createFlag) {
            ...
            projectCheckpoint = (ProjectCheckpoint)this.getIntent().getSerializableExtra(
                    "projectCheckpoint");
        }
    ...
    protected void onResume() {
        ...
        if (projectCheckpoint.getPhotoPath() != null) {
            checkpointPhoto.setImageURI(Uri.fromFile(new File(projectCheckpoint.getPhotoPath())));
        }
    ...
    private OnClickListener submitListener = new OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            projectCheckpoint.setNumberDefect(qcDefectEditText.getText().toString());
